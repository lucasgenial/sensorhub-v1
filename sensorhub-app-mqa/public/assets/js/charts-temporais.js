...
function criaGraficoMQ2() {
    criaGraficoSensor('graficoInflamaveis', 'MQ2_GLP',
        'Gases Inflamáveis - MQ2 - GLP', 'PPM MQ2');
}
function criaGraficoMQ9() {
    criaGraficoSensor('graficoMonoxido', 'MQ9_CO',
        'Monóxido de Carbono - MQ9', 'PPM MQ9');
}
function criaGraficoMQ135() {
    criaGraficoSensor('graficoToxicos', 'MQ9_Metano',
        'Gases Tóxicos - MQ9', 'PPM MQ9');
}
